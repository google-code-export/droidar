package gui.v2.simpleUi.customViews;

import gui.v2.simpleUi.util.ColorCollections;
import gui.v2.simpleUi.util.IO;
import gui.v2.simpleUi.util.ImageTransform;
import gui.v2.simpleUi.util.NameGenerator;
...
public class SimpleRatingBar extends TextView {
	...
	private Bitmap createLineBitmap(RatingItem item) {
		...
		System.out.println("new bitmapt for " + item.getName());
